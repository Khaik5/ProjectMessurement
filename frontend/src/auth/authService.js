...
export const authService = {
  ...
  publicRegister: (payload) => axiosClient.post('/auth/public-register', payload).then((res) => res.data),
  ...
  updateUserRole: (id, role) => axiosClient.patch(`/auth/users/${id}/role`, { role }).then((res) => res.data),
